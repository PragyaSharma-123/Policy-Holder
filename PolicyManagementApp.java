...
public class PolicyManagementApp 
{
    public static void main(String[] args) 
    {
        ...
        policyList.add(new PolicyHolder("P001", "Neha", 50000, 5));
        policyList.add(new PolicyHolder("P002", "Pragya", 150000, 3));
        policyList.add(new PolicyHolder("P003", "Sid", 200000, 10)); 
        policyList.add(new PolicyHolder("P004", "Shivang", 80000, 2));
